export const MessageSVG = ({ size = 24, color = "currentColor" }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <g clipPath="url(#clip0_4418_4513)">
        <path
          opacity="0.4"
        ...
        />
        <path
          d="M21.9998 12.8603C21.9998 15.1503 20.8198 17.1803 18.9998 18.4603L17.6598 21.4103C17.3498 22.0803 16.4498 22.2103 15.9798 21.6403L14.4998 19.8603C12.0798 19.8603 9.91982 18.7903 8.56982 17.1203L9.49982 16.0003C13.6398 16.0003 16.9998 12.8703 16.9998 9.00031C16.9998 7.95031 16.7498 6.96031 16.2998 6.07031C19.5698 6.82031 21.9998 9.58029 21.9998 12.8603Z"
          fill="currentColor"
        />
        <path
