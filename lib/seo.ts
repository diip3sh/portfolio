...
export const SITE_TITLE = "Dipesh | Fine Engineer"
export const SITE_DESCRIPTION =
  "Dipesh is a design and frontend engineer from India building polished digital products with thoughtful UX, motion, and modern web technology."
...
export const DEFAULT_SOCIAL_IMAGE = {
  ...
  width: 1622,
  height: 970,
  alt: "Dipesh — Design Engineer and Frontend Engineer from India",
} as const
